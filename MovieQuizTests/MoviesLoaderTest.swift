...
//  MovieQuizTests
//
//  Created by Ramil Yanberdin on 23.02.2023.
//
...
class MoviesLoaderTest: XCTestCase {
    ...
    func testFailureLoading() throws {
        //Given
        let stubsNetworkClient = StubNetworkClient(emulateError: true)
        let loader = MoviesLoader(networkClient: stubsNetworkClient)
        
        //When
        let expectation = expectation(description: "Loading fail expectation")
